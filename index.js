...
function createUser() {
  ...
  axios
    .post("https://assignmentthre.herokuapp.com/user", {
      name,
      email,
      address,
    })
...
function getAllUser() {
  axios
    .get("https://assignmentthre.herokuapp.com/users")
    .then(function (response) {
      console.log(response);
...
function deleteUser(_id) {
  axios
    .delete(`https://assignmentthre.herokuapp.com/user/${_id}`)
    .then(function (response) {
      console.log(response);
...
function updateUser(_id) {
  ...
  axios
    .put(`https://assignmentthre.herokuapp.com/user/${_id}`, {
      name,
      email,
      address,
    })
